...
#                     key = argument['argument'] # 蔚蓝
#                     value = (event['event_type'], argument['role']) #（”组织关系-裁员“，”裁员方“）
#                     arguments[key] = value
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('ee_best_model.weights')
        print(
...
if __name__ == '__main__':
    ...
    if train:
        ...
        predict_to_file('../data/test1_data/test1.json', 'op_pred.json')
